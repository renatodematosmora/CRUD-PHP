...
@section('content')
<h1 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Cadastrar Animal</h1>
<br>
@if ($errors->any())
    <ul>
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input type="text" name="breed" id="breed" value="{{ old('breed') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="type" id="type" placeholder="Espécie" value="{{ old('type') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
